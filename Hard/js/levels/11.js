var oneone = Mario.oneone = function() {
  ...
  level.putBrick(43, 6, null);
  // level.putBrick(45, 10, null);
  level.putPipe(46, 13, 7);
  ...
  // level.putBrick(2, 1, null);
  // level.putBrick(3, 1, null);
  // level.putBrick(4, 1, null);
  // level.putBrick(3, 2, null);
  // level.putBrick(3, 3, null);
  // level.putBrick(6, 1, null);
  // level.putBrick(6, 2, null);
  // level.putBrick(6, 3, null);
  // level.putBrick(7, 2, null);
  // level.putBrick(8, 1, null);
  // level.putBrick(8, 2, null);
  // level.putBrick(8, 3, null);
  // level.putBrick(10, 1, null);
  // level.putBrick(11, 2, null);
  // level.putBrick(12, 3, null);
  // level.putBrick(12, 1, null);
  // level.putBrick(10, 3, null);
  ...
  level.putKoopa(150, 7);
  level.putGoomba(139, 12);
  level.putGoomba(170, 12);
  level.putGoomba(172, 12);
  level.putGoomba(185, 3);
  level.putKoopa(187, 3);
  level.putGoomba(196, 12);
  level.putKoopa(35, 11);
  level.putGoomba(25, 7);
